...
public class CompletedBookingsFragment extends Fragment {
    ...
    ArrayList<Bookings> completedBookingsList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        CompletedBookingsAdapter completedBookingsAdapter = new CompletedBookingsAdapter(getContext(), BookingsFragment.al_completed_bookings);
